...
/**
 * Decorator that sets the enumerable property of a class member.
 * @param value - A boolean value indicating whether the property should be enumerable.
 * @returns A decorator function that sets the enumerable property of the target class member.
 */
